...
func main() {
	...
	case "1":
		...
		runtime.GC()
		fmt.Printf("With %T, GC took %d ns\n", m, timeGC().Nanoseconds())
	...
	case "3":
		...
		runtime.GC()
		fmt.Printf("With map shards (%T), GC took %d ns\n", shards, timeGC().Nanoseconds())
		_ = shards[0][0]
	...
	case "4":
		...
		runtime.GC()
		fmt.Printf("With a plain slice (%T), GC took %d ns\n", s, timeGC().Nanoseconds())
		_ = s[0]
